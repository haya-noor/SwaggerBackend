...
async function uploadFile() {
    ...
    const tsFilePath = path_1.default.join(__dirname, `../http/output/swagger-${branchName}-v${version}.ts`);
    generateSwaggerJson();
    ...
    try {
        ...
        const files = (_a = searchResponse.data.files) !== null && _a !== void 0 ? _a : [];
        if (files.length > 0 && ((_b = files[0]) === null || _b === void 0 ? void 0 : _b.id)) {
            const fileId = (_c = files[0].id) !== null && _c !== void 0 ? _c : '';
